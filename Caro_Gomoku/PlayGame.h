...
int Load_Game(char a[][42], int &row, int &column, char &charX, char &charO, int &coX, int &coO, int &PvP);					// Load game
int Save_Game(char a[][42], int &row, int &column, char &charX, char &charO, int &coX, int &coO);		// Save game
