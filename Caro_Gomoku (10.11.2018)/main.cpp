...
int Load_Game(char a[][42], int &row, int &column, char &charX, char &charO, int &PvP);					// Load game
int Save_Game(char a[][42], int &row, int &column);		// Save game
void Undo(char a[][42], int &row, int &column, int n, int &step, int x, int y,
	int curX, int curY, char &charX, char &charO, int score[][42], int Enemyscore[][42]);			// Undo move
